...
function Results (props) {
  ...
  <If condition={props.loading}>
    ...
    <Else>
      <When condition={ Object.keys(props.results).length>0 }>
        <>
          <aside className="history">
          <History calls={props.history} updateRequest={props.updateRequest} historyHandler={props.historyHandler}/>

          </aside>

          <If condition={props.results}>
            <Then>
              ...
              <h3 data-testid="count">Count: {props.count}</h3>
                ...
                <h2>Result</h2>
                <div data-testid="results"><ReactJson name='Result' src={props.results}  data-testid="results" className="react-json-view" /></div>
